...
public class sendm {
    ...
    String toWhom="laamiri.oussema@gmail.com";
    String messagae="aaaaa";
    String subject="adzadaz";
    ...
    public void createEmailMessage() throws AddressException, MessagingException {
        ...
        messagae = messageBind.getValue().toString(); // Value from page(Message/Mail)
    ...
    public void sendEmail() {
        ...
        String fromUser ="laamiri.oussema"; //just the id alone without @gmail.com
        String fromUserEmailPassword ="frenicfrenic23";
